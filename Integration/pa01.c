...
int main(int argc, char * * argv)
{
   ...
   print_fourier_coefficients(fourier_arg.a_i, fourier_arg.b_i, 
	...
	function_plot(fourier_arg.intg.func_to_be_integrated,
                   fourier_arg.intg.lower_limit, fourier_arg.intg.upper_limit,
                   fourier_arg.a_i, fourier_arg.b_i, fourier_arg.n_terms, "filename.m") ;
   free(fourier_arg.a_i);
